...
if _has("AUTH_OIDC_PROVIDER"):
    ...
    OIDC_CUSTOM_USERNAME_CLAIM = _get("UATH_OIDC_USERNAME_CLAIM", "username_claim")
    ...
    if oidc_logout:
        ...
        OIDC_CUSTOM_LOGOUT_ID_TOKEN_HINT = _get("AUTH_OIDC_LOGOUT_ID_TOKEN_HINT", "id_token_hint")
...
CAPTCHAS_PASSWORD_RESET = _enabled("SECURITY_CAPTCHAS_PASSWORD_RESET")
...
BADGE_BUILD_TIMEOUT = 60 * get_int("BADGE_BUILD_TIMEOUT", 5)
...
# automation
AUTOMATION_EVENTS_ARCHIVE_DEADLINE = _get("AUTOMATION_ARCHIVE_DEADLINE", None)
AUTOMATION_EVENTS_ARCHIVE_INTERVAL = _get("AUTOMATION_ARCHIVE_INTERVAL", None)
AUTOMATION_EVENTS_ARCHIVE_START_BEFORE_DEADLINE = _get_int("AUTOMATION_START_BEFORE_DEADLINE", 0)
AUTOMATION_EVENTS_ARCHIVE_DOCS = _get_int("AUTOMATION_ARCHIVE_DOCS", None)
